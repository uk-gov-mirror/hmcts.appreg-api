...
public interface ApplicationRepository extends JpaRepository<Application, Long> {
    ...
    /**
     * Finds a single application by ID, ensuring it belongs to the specified application list
     * and that the list is owned by the given user.
     *
     ...
     */
    Optional<Application> findByIdAndApplicationListIdAndApplicationListUserId(Long id, Long listId, String userId);

    /**
     * Finds all applications with the given IDs that are accessible to a specific user.
     * Only applications belonging to lists owned by that user will be returned.
     *
