...
class ApplicationListEntryEntityMapperTest {
    ...
    void testToApplicationListEntry() {
        ...
        NameAddress applicant =
            Instancio.of(NameAddress.class).withSettings(settings).create();
        ...
        Assertions.assertEquals(entryCreateDto.getAccountNumber(), applicationListEntry.getAccountNumber());
        Assertions.assertEquals(entryCreateDto.getCaseReference(), applicationListEntry.getCaseReference());
    ...
    void testToApplicantPerson() {
        ...
        Assertions.assertEquals(applicant.getPerson().getName().getThirdForename(), nameAddress.getForename3());
        Assertions.assertEquals(applicant.getPerson().getName().getSurname(), nameAddress.getSurname());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getPhone(), nameAddress.getTelephoneNumber());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getEmail(), nameAddress.getEmailAddress());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getAddressLine1(), nameAddress.getAddress1());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getAddressLine2(), nameAddress.getAddress2());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getAddressLine3(), nameAddress.getAddress3());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getAddressLine4(), nameAddress.getAddress4());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getAddressLine5(), nameAddress.getAddress5());
        Assertions.assertEquals(applicant.getPerson().getContactDetails().getPostcode(), nameAddress.getPostcode());
    }
    ...
    void testToApplicantOrganisation() {
        ...
        Assertions.assertEquals(applicant.getOrganisation().getContactDetails().getEmail(), nameAddress.getEmailAddress());
        Assertions.assertEquals(applicant.getOrganisation().getContactDetails().getAddressLine1(), nameAddress.getAddress1());
        Assertions.assertEquals(applicant.getOrganisation().getContactDetails().getAddressLine2(), nameAddress.getAddress2());
        Assertions.assertEquals(applicant.getOrganisation().getContactDetails().getAddressLine3(), nameAddress.getAddress3());
        Assertions.assertEquals(applicant.getOrganisation().getContactDetails().getAddressLine4(), nameAddress.getAddress4());
        Assertions.assertEquals(applicant.getOrganisation().getContactDetails().getAddressLine5(), nameAddress.getAddress5());
        Assertions.assertEquals(applicant.getOrganisation().getContactDetails().getPostcode(), nameAddress.getPostcode());
    }
    ...
    void testToRespondentPerson() {
        ...
        Assertions.assertEquals(respondent.getPerson().getName().getSurname(), nameAddress.getSurname());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getPhone(), nameAddress.getTelephoneNumber());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getEmail(), nameAddress.getEmailAddress());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getAddressLine1(), nameAddress.getAddress1());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getAddressLine2(), nameAddress.getAddress2());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getAddressLine3(), nameAddress.getAddress3());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getAddressLine4(), nameAddress.getAddress4());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getAddressLine5(), nameAddress.getAddress5());
        Assertions.assertEquals(respondent.getPerson().getContactDetails().getPostcode(), nameAddress.getPostcode());
    }
    ...
    void testToRespondentOrganisation() {
        ...
        Assertions.assertEquals(respondent.getOrganisation().getContactDetails().getAddressLine1(), nameAddress.getAddress1());
        Assertions.assertEquals(respondent.getOrganisation().getContactDetails().getAddressLine2(), nameAddress.getAddress2());
        Assertions.assertEquals(respondent.getOrganisation().getContactDetails().getAddressLine3(), nameAddress.getAddress3());
        Assertions.assertEquals(respondent.getOrganisation().getContactDetails().getAddressLine4(), nameAddress.getAddress4());
        Assertions.assertEquals(respondent.getOrganisation().getContactDetails().getAddressLine5(), nameAddress.getAddress5());
        Assertions.assertEquals(respondent.getOrganisation().getContactDetails().getPostcode(), nameAddress.getPostcode());
    }
}
