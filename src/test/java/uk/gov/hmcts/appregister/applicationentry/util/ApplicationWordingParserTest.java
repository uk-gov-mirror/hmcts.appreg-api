...
class ApplicationWordingParserTest {
  ...
  void generateWording_notEnoughInputFields_throwsException() {
    ...
    IllegalArgumentException ex =
        assertThrows(IllegalArgumentException.class, () -> parser.generateWording(template, input));
  ...
  void generateWording_nullInputFields_throwsException() {
    ...
    IllegalArgumentException ex =
        assertThrows(IllegalArgumentException.class, () -> parser.generateWording(template, null));
