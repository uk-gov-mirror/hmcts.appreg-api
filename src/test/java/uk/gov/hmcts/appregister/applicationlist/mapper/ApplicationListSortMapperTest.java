...
public class ApplicationListSortMapperTest {
    ...
    void mapAndValidate_validSingleFieldWithAscDirection_returnsMappedFieldWithAsc() {
        List<String> result = mapper.mapAndValidate(List.of(ApplicationListApiFields.STATUS + ",asc"));
        assertEquals(1, result.size());
    ...
    void mapAndValidate_validSingleFieldWithDescDirection_returnsMappedFieldWithDesc() {
        List<String> result = mapper.mapAndValidate(List.of(ApplicationListApiFields.CJA + ",desc"));
        assertEquals(1, result.size());
    ...
    void mapAndValidate_invalidDirection_throwsException() {
        AppRegistryException ex = assertThrows(AppRegistryException.class,
                                               () -> mapper.mapAndValidate(List.of(ApplicationListApiFields.DATE + ",up")));
