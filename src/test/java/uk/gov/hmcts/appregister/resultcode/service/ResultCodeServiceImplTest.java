...
class ResultCodeServiceImplTest {
    ...
    private static Page<ResultCode> pageWithTotal(List<ResultCode> content, Pageable pageable, long total) {
    ...
    void findAll_mapsEntitiesToDtos_andReturnsList() {
        ...
        ResultCodeDto d1 = new ResultCodeDto(1L, "RC1", "Title1", "Wording1", "Leg1",
                                             "a@b.com", null, LocalDate.parse("2020-01-01"), null);
        ResultCodeDto d2 = new ResultCodeDto(2L, "RC2", "Title2", "Wording2", null,
                                             null, "c@d.com", LocalDate.parse("2020-02-02"), LocalDate.parse("2020-12-31"));
    ...
    void findByCode_whenFound_mapsAndReturnsDto() {
        ...
        ResultCodeDto dto = new ResultCodeDto(99L, code, "X", "W", null, null, null,
    ...
    void search_withCodeOnly_buildsSpec_andMapsListItems() {
        ...
        when(repository.findAll(ArgumentMatchers.<Specification<ResultCode>>any(), any(Pageable.class)))
            .thenReturn(repoPage);
        when(mapper.toListItem(e)).thenReturn(dto);

        Page<ResultCodeListItemDto> out = service.search(
            code, null, null, null, null, null, pageable);
    ...
    void search_withTitleOnly_buildsSpec_andMapsListItems() {
        ...
        Page<ResultCodeListItemDto> out = service.search(
            null, title, null, null, null, null, pageable);
    ...
    void search_withAllFilters_buildsSpec_andMapsListItems() {
        ...
        ResultCode e = ResultCode.builder().id(11L).resultCode("RC11").title("Appeal Granted").build();
        ...
        Page<ResultCodeListItemDto> out = service.search(
            code, title, startFrom, startTo, endFrom, endTo, pageable);
    ...
    void search_withDateBounds_buildsCompositeSpec_andMaps() {
        ...
        Page<ResultCodeListItemDto> out = service.search(
            null, null, startFrom, startTo, endFrom, endTo, pageable);
    ...
    void search_withNoFilters_returnsEmptyPage_andSkipsMapper() {
        ...
        verify(repository).findAll(ArgumentMatchers.<Specification<ResultCode>>any(), any(Pageable.class));
        verifyNoInteractions(mapper);
    }
}
