...
class ResolutionCodeMapperTest {
    ...
    void toReadDto_mapsAllFields() {
        ...
        assertThat(dto.startDate()).isEqualTo(OffsetDateTime.of(2024, 1, 1, 0, 0, 0, 0, ZoneOffset.UTC));
        assertThat(dto.endDate()).isEqualTo(OffsetDateTime.of(2025, 12, 31, 0, 0, 0, 0, ZoneOffset.UTC));
    }
    ...
    void toEntityFromReadDto_mapsAllFields() {
        ResolutionCodeDto dto =
                new ResolutionCodeDto(
                        ...
                        OffsetDateTime.of(2024, 5,
                                          10, 0, 0, 0, 0, ZoneOffset.UTC));
        ...
        assertThat(entity.getStartDate()).isEqualTo(OffsetDateTime.of(2023, 5, 10, 0, 0, 0, 0, ZoneOffset.UTC));
        assertThat(entity.getEndDate()).isEqualTo(OffsetDateTime.of(2024, 5, 10, 0, 0, 0, 0, ZoneOffset.UTC));
    }
