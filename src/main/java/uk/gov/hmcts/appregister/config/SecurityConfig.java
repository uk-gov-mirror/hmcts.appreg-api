...
public class SecurityConfig {
   ...
   * stateless JWT-based APIs). - Secures endpoints based on roles from the "roles" claim. - Exposes
   * Swagger/OpenAPI/health endpoints without authentication. - Configures JWT as the auth
        ...
        .oauth2ResourceServer(
            oauth ->
                oauth
                    ...
                    .authenticationEntryPoint((req, res, ex) -> res.sendError(ERR_AUTH_REQUIRED)))
        .exceptionHandling(
