 ...
 *
 * <p>This class represents a single Result Code record in the database. It contains
 * the full metadata required for display in admin and ALE workflows, including
 * wording, legislation, destination email addresses, and validity dates.</p>
 *
 * <p><strong>Lombok Annotations:</strong>
 * <ul>
 *   <li>{@link Data} – generates getters, setters, equals/hashCode, and toString.</li>
 *   <li>{@link Builder} – enables fluent builder API for constructing instances.</li>
 *   <li>{@link NoArgsConstructor} / {@link AllArgsConstructor} – provide convenience constructors.</li>
 * </ul>
 *
 * <p><strong>Database Annotations:</strong>
 * <ul>
 *   <li>{@link Entity} – marks this as a JPA entity.</li>
 *   <li>{@link Table} – maps the entity to the {@code resolution_codes} table.</li>
 *   <li>{@link Column} – customises column mapping, constraints, and lengths.</li>
 * </ul>
 */
@Entity
