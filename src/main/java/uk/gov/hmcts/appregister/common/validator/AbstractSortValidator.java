...
public abstract class AbstractSortValidator implements Validator<String>{
    ...
    /**
     * validates the sort value against the valid sort properties. An exception is expected to be thrown on
     * an error occurring
    ...
    /**
     * gets the valid sort properties, based on the columns of the JPA table columns.
     * We should use the entity constants where possible. For an example use
     * see {@link uk.gov.hmcts.appregister.common.entity.ApplicationCode_}
