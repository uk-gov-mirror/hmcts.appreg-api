 ...
 *
 * <p>Guarantees a single match or throws a domain-specific {@link AppRegistryException}.
 * Normalises input (trimming) and provides Optional-based finders for callers that
 * want to handle absence themselves.
 *
