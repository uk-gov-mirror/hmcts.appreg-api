 ...
 * processing asynchronously. The message will be reflected as an error in the job status.
 * {@link uk.gov.hmcts.appregister.common.async.JobContext#logError(String)}
 */
