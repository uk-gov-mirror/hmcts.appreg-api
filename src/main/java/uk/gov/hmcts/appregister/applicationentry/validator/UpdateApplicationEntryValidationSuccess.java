...
@Getter
@Setter
public class UpdateApplicationEntryValidationSuccess extends CreateApplicationEntryValidationSuccess {
    public UpdateApplicationEntryValidationSuccess(WordingTemplateSentence wordingSentence,
                                                   ApplicationCode applicationCode,
                                                   Fee fee, StandardApplicant sa, ApplicationList applicationList,
