 ...
 * <p>Features:
 * <ul>
 *   <li><strong>Paginated, filterable listing</strong> for Admin and ALE flows.</li>
 *   <li><strong>Fetch-by-code</strong> endpoint returning full metadata for a single code.</li>
 * </ul>
 *
 ...
 *
 * <p><strong>Validation</strong>: Date range inputs are validated by {@link DateRangeValidator}.
 * If an invalid range is supplied (e.g., {@code startDateFrom > startDateTo}), a {@code 400} is returned.
 */
@RestController
...
public class ResolutionCodeController {
     ...
     *
     * <p>On missing entity, the service throws a {@code ResponseStatusException(HttpStatus.NOT_FOUND)},
     * which Spring maps to {@code 404 Not Found}.</p>
     *
    ...
    public ResponseEntity<ResolutionCodeDto> getByCode(@PathVariable String code) {
        // Service encapsulates repository and mapping; exceptions bubble up for Spring to translate.
