 ...
 * legislation references, destination email addresses, and validity dates. It is the persistence-layer
 * model that maps directly to the database schema and should not be exposed directly in API responses.
 * For API exposure, use {@link uk.gov.hmcts.appregister.resolutioncode.dto.ResolutionCodeDto}
 * or {@link uk.gov.hmcts.appregister.resolutioncode.dto.ResolutionCodeListItemDto} created via a
 * mapper component.</p>
 *
 * <p><strong>Lombok annotations:</strong>
 * <ul>
 *   <li>{@link Data} – generates getters, setters, equals/hashCode, and toString methods.</li>
 *   <li>{@link Builder} – enables a fluent builder API for constructing instances.</li>
 *   <li>{@link NoArgsConstructor} and {@link AllArgsConstructor} – provide convenience constructors.</li>
 * </ul>
 *
 * <p><strong>Database mapping:</strong>
 * <ul>
 *   <li>{@link Entity} – marks this as a JPA-managed entity.</li>
 *   <li>{@link Table} – maps this entity to the {@code resolution_code} table.</li>
 *   <li>{@link Column} – defines explicit column mappings, constraints, and lengths.</li>
 * </ul>
 */
@Entity
...
public class ResolutionCode {
    ...
    /**
     * End date (inclusive) until which this resolution code remains valid, or {@code null} if ongoing.
     */
