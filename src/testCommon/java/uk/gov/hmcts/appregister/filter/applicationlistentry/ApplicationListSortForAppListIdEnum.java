 ...
 */
public enum ApplicationListSortForAppListIdEnum
        implements SortMetaDescriptorEnum<ApplicationListEntry> {
    SEQUENCE_NUMBER(
            SortMetaDataDescriptor.<ApplicationListEntry>builder()
                    ...
                    .sortableValueFunction(
                            (ale) -> Integer.valueOf(ale.getSequenceNumber().intValue()))
                    .defaultSort(true)
                    .sortGenerator(
    ...
    RESPONDENT_POSTCODE(
            SortMetaDataDescriptor.<ApplicationListEntry>builder()
                    .sortableOperationEnum(
                            ApplicationEntryByListIdSortFieldEnum.RESPONDENT_POSTCODE)
                            ...
                            new GenerateAccordingToSort<ApplicationListEntry>() {
                                ...
                                public void apply(
                                    ...
                                    respondent.setPostcode(
                                            PrimitiveDataGenerator.generate(count, 8));
                                }
                            })
                    .build()),
    ACCOUNT_REFERENCE(
    ...
    ApplicationListSortForAppListIdEnum(
