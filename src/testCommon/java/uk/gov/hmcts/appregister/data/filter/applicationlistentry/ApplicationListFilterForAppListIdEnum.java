 ...
 */
public enum ApplicationListFilterForAppListIdEnum implements FilterMetaDescriptorEnum<ApplicationListEntry> {
    SEQUENCE(
            FilterFieldDataMetaDescriptor.<ApplicationListEntry>builder()
                    ...
                    .filterGenerator(
                            (count, keyable, descriptor) -> {
                                ...
                                FilterFieldValue<ApplicationListEntry> filterFieldValue = new FilterFieldValue<>();
    ...
    TITLE(
            FilterFieldDataMetaDescriptor.<ApplicationListEntry>builder()
                    ...
                    .build()),
    // TODO: We need to address this when we have corrected as part of https://tools.hmcts.net/jira/browse/ARCPOC-1301.
    /*APPLICANT(
        FilterFieldDataMetaDescriptor.<ApplicationListEntry>builder()
            .queryName("applicationTitle")
            .partialSupport(true)
            ...
            FilterFieldDataMetaDescriptor.<ApplicationListEntry>builder()
                    ...
                    .filterGenerator(
                            (count, keyable, descriptor) -> {
                                ...
                                respondent.setPostcode(filterFieldData.getKeyableValues().getValue().toString());
                                return filterFieldData;
                            })
                    .build()),
    ACCOUNT_REFERENCE(
        ...
        FilterFieldDataMetaDescriptor.<ApplicationListEntry>builder()
            ...
            .filterGenerator(
                (count, keyable, descriptor) -> {
                    ...
                    resolutionCode.setResultCode(filterFieldData.getKeyableValues().getValue().toString());
        ...
        FilterFieldDataMetaDescriptor.<ApplicationListEntry>builder()
            ...
            .filterGenerator(
                (count, keyable, descriptor) -> {
                    ...
                    FilterFieldData<ApplicationListEntry> filterFieldData =
                        new FilterFieldData<>();
                    FilterFieldValue<ApplicationListEntry> value = new FilterFieldValue<>();
