...
public class ApplicationListController {
    ...
    private final static Logger log = LoggerFactory.getLogger(ApplicationListController.class);
    ...
    public ResponseEntity<ApplicationListDto> getById(
        ...
        log.info("Getting application list with id: {}, for user: {}", id, jwt.getClaimAsString("sub"));
        String userId = jwt.getClaimAsString("oid");
    ...
    public ResponseEntity<ApplicationListDto> update(
        ...
        log.info("Updating application list with id: {}, for user: {}", id, jwt.getClaimAsString("sub"));
        String userId = jwt.getClaimAsString("oid");
    ...
    @Operation(
        summary = "Delete an application list by ID",
    ...
    public ResponseEntity<Void> delete(
        ...
        log.info("Deleting application list with id: {}, for user: {}", id, jwt.getClaimAsString("sub"));
        String userId = jwt.getClaimAsString("oid");
